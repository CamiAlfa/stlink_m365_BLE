...
@timeout 5
@openocd.exe -f ../scripts/interface/cmsis-dap.cfg -f ../scripts/target/nrf51_100k.cfg -c "init" -c "reset halt" -c "nrf51 mass_erase" -c "program classic073_flash.hex verify" -c "reset run" -c "exit"
@pause